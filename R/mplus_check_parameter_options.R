...
#' @param parameter_type One of 'parameters', 'paramheader' or 'display'. These display options which can be entered in 'param_header', 'parameter', or 'display' in [MplusReadR::mplus_compile()].It is also possible to select 'outcomes' and 'variables' for Dejonckheere project models.
