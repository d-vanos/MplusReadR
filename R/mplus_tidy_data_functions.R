...
#' @import dplyr
#'
#' @param Mplus_file An Mplus object generated by the Mplus Automation package from Mplus output using the readModels() function. Can contain multiple MPlus files.
...
mplus_tidy_univar <- function (Mplus_file, model_n, standardised = TRUE) {
...
mplus_tidy_bivar <- function (Mplus_file, model_n, standardised = TRUE) {
...
mplus_tidy_data <- function (Mplus_file, model_n, model_type, rounding = 2, parameters = NULL, variables = NULL, paramheaders = NULL, standardised = TRUE, outcomes = NULL) {
