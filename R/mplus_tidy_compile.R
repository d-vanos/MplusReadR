...
#'
#' @import dplyr
#' @param Mplus_file An mplus object generated by the Mplus Automation package from Mplus output using the readModels() function.
...
mplus_tidy_compile <- function(Mplus_file, model_type, rounding = 2, parameters = NULL, variables = NULL, paramheaders = NULL, outcomes = NULL, standardised = TRUE){
  ...
  for(n in 1:length(Mplus_file)){
    temp_data <- mplus_tidy_data(Mplus_file, model_n = n, model_type = model_type, rounding = rounding, parameters = parameters,
